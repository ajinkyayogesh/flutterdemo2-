...
class SelectUserforAddrent extends StatefulWidget {
...
class _GetAllRant_USer_DeatilsState extends State<SelectUserforAddrent> {
  final Dio _dio = Dio();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Select User', style: TextStyle(color: Colors.white)),
                ...
                return GestureDetector(
                  onTap: () async {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => AddRant(user: user),
                        ),
                      );
